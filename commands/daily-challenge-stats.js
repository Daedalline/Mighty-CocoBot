...
module.exports.run = async(interaction, config, maps, client) => {
    ...
    if(typeof player_data == 'undefined') {
        ...
        tbl += "Participation Awards - " + player_data["Current Season"]["Participation Awards"] + " Medals\n";
        ...
        tbl += "Participation Awards - " + player_data["Lifetime"]["Participation Awards"] + " Medals\n";
